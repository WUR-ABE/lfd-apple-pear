...
class GMMR(BaseEstimator):
    def __init__(self, nb_states=5, reg=1e-8, num_iter=100, diag=False, dep_mask=None):
    ...
    def fit(self, data):
        ...
        # Train model
        gamma, model_LL = self.gmm_.em(gmm_demos2, reg=reg, verbose=True, maxiter=self.num_iter, diag=self.diag, dep_mask=self.dep_mask)
